...
from app.forms import LoginForm, RegistrationForm, \
    EditProfileForm, PostForm, EmptyForm, ResetPasswordForm
...
def index():
    ...
    page = request.args.get('page', default=1, type=int)    # get page and convert to int or 1
    posts = current_user.followed_posts().paginate(
        page, app.config['POSTS_PER_PAGE'], False)  # object Pagination
